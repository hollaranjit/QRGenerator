package com.example.qrcodegenerator.signUp
...
class SignUpActivity : AppCompatActivity() {
    ...
    private fun registerUser()
    {
        ...
        val zucitechID : String = etZucitechID.text.toString().trim()
        ...
        else
        {
            ...
            mAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener{task->
                ...
                if (task.isSuccessful)
                {
                    ...
                    refUsers = FirebaseDatabase.getInstance(PATH).reference.child("Admin").child(firebaseUserID)
